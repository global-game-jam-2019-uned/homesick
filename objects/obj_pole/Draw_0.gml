...
if(distance_to_dog < 1000){
	
	draw_text_color(x, y - 40, point_distance(obj_dog.x, obj_dog.y, x, y), c_green,0,0,0,1);
	draw_text_color(obj_dog.x, obj_dog.y - 140, obj_dog.image_index, c_green,0,0,0,1);
	draw_text_color(obj_dog.x, obj_dog.y - 190, obj_dog.image_speed, c_green,0,0,0,1);
